...
from app.models import Analisis, Cubrimiento, CubrimientoDecision, ProgramacionCarga, Puesto, Turno, Ubicacion, Usuario
from app.models.cubrimientos import APROBADO, JUSTIFICADO, PENDIENTE, RECHAZADO
from app.models.maestros import TRABAJO
from app.schemas.f1 import PuestoOut
from app.services import cubrimientos as svc
...
def decidir(analisis_id: int, data: DecisionIn, request: Request, db: DbSession,
            actual: Usuario = Depends(require("cubrimientos.aprobar"))):
    a, carga = _analisis(db, analisis_id)
...
def bolsas(analisis_id: int, db: DbSession, todas: bool = False, _=Depends(require("analisis.ver"))):
