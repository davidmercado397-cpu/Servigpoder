...
from app.models import Novedad, Turno, Usuario
from app.schemas.f1 import NovedadIn, NovedadOut, TurnoOut
from app.services.catalogos import importar_turnos

router = APIRouter(prefix="/catalogos", tags=["catálogos"])


@router.get("/turnos", response_model=ApiResponse[list[TurnoOut]])
def listar_turnos(db: DbSession, _=Depends(require("maestros.ver"))):
...
def listar_novedades(db: DbSession, _=Depends(require("maestros.ver"))):
