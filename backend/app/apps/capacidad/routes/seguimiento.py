...
def alertas(db: DbSession, _=Depends(require("capacidad.analisis.ver"))):
...
def contadores(db: DbSession, _=Depends(require("capacidad.analisis.ver"))):
...
def listar_parametros(db: DbSession, _=Depends(require("capacidad.analisis.ver"))):
...
def guardar_parametro(clave: str, data: ParametroIn, request: Request, db: DbSession,
                      actual: Usuario = Depends(require("capacidad.parametros.gestionar"))):
