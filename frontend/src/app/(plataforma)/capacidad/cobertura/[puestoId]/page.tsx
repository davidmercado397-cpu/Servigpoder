...
function Detalle() {
  ...
  useEffect(() => {
    ...
    api<DetallePuesto>(`/capacidad/analisis/${analisisId}/puestos/${puestoId}`).then(setD).catch((e) => setError(mensajeError(e)));
  }, [analisisId, puestoId]);
  ...
  return (
    <div className="max-w-full space-y-5">
      <div>
        <Link href="/capacidad/cobertura" className="text-sm text-marca-600 hover:underline">← Volver al tablero</Link>
