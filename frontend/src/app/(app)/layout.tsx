...
import {
  Bell, ChevronsLeft, ChevronsRight, Database, FileSpreadsheet, Gauge, History, Inbox, KeyRound, LayoutDashboard,
  LogOut, Menu, ShieldCheck, SlidersHorizontal, Table2, UserCog, Users, X, type LucideIcon,
} from "lucide-react";
...
const MENU: { grupo: string; items: Item[] }[] = [
  { grupo: "General", items: [{ href: "/", texto: "Inicio", icono: LayoutDashboard, contador: "alertas_criticas", critico: true }] },
  {
    grupo: "Operación",
    items: [
      { href: "/programacion", texto: "Programación SIESA", icono: FileSpreadsheet, permiso: "analisis.ver" },
      { href: "/cobertura", texto: "Cobertura", icono: Gauge, permiso: "analisis.ver" },
      { href: "/cubrimientos", texto: "Cubrimientos (nómina)", icono: Inbox, permiso: "analisis.ver", contador: "cubrimientos_pendientes" },
      { href: "/bolsas", texto: "Personas en bolsa", icono: Users, permiso: "analisis.ver" },
      { href: "/historico", texto: "Histórico y novedades", icono: History, permiso: "analisis.ver" },
    ],
  },
  {
    grupo: "Configuración",
    items: [
      { href: "/matriz", texto: "Matriz comercial", icono: Table2, permiso: "matriz.ver" },
      { href: "/maestros", texto: "Maestros", icono: Database, permiso: "maestros.ver", contador: "por_aclarar" },
    ],
  },
  {
    grupo: "Administración",
    items: [
      { href: "/admin/usuarios", texto: "Usuarios", icono: UserCog, permiso: "usuarios.ver" },
      { href: "/admin/roles", texto: "Roles y permisos", icono: KeyRound, permiso: "roles.ver" },
      { href: "/admin/parametros", texto: "Parámetros de alertas", icono: SlidersHorizontal, permiso: "parametros.gestionar" },
    ],
  },
];
...
function Shell({ children }: { children: React.ReactNode }) {
  ...
  const puedeAnalisis = sesion.permisos.includes("analisis.ver");
  ...
  useEffect(() => {
    ...
    if (puedeAnalisis) api<Contadores>("/menu/contadores").then(setContadores).catch(() => {});
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-slate-200 bg-white/85 px-4 backdrop-blur lg:px-8">
          ...
          <div className="ml-auto flex items-center gap-4">
            ...
            {puedeAnalisis && (
              <Link href="/" className="relative rounded-full p-2 text-slate-500 transition hover:bg-slate-100 hover:text-marca-700" title="Alertas" aria-label="Alertas">
